...
import com.example.driverapp.ui.chat.MessageDetails;
import com.example.driverapp.R;
import com.example.driverapp.model.Message;

import java.util.ArrayList;

public class MessageAdapter extends RecyclerView.Adapter<com.example.driverapp.controller.MessageAdapter.MessageViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.driverapp.controller.MessageAdapter.MessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.message_list, parent, false);
        return new com.example.driverapp.controller.MessageAdapter.MessageViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull com.example.driverapp.controller.MessageAdapter.MessageViewHolder holder, int position) {
